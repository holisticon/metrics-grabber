...
import de.holisticon.monitoring.tools.metricsgrabber.core.config.Activateable;
...
/**
 * Class for filtering {@link de.holisticon.monitoring.tools.metricsgrabber.core.config.Activateable} arrays.
...
public final class ActivateableFilter {
    ...
    /**
     * Filters an array of instances of type marked with the {@link de.holisticon.monitoring.tools.metricsgrabber.core.config.Activateable} interface.
     * The filter keeps the order of elements.
     * @param arrayToFilter the array to filter
     * @param type The type of the array(must extend {@link de.holisticon.monitoring.tools.metricsgrabber.core.config.Activateable})
